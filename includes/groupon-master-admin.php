...
<?php
if(!class_exists('groupon_master_admin_table_support')){
	require_once( dirname( __FILE__ ) . '/groupon-master-admin-table-support.php');
}
//Prepare Table of elements
$wp_list_table = new groupon_master_admin_table_support();
//Table of elements
$wp_list_table->display();
